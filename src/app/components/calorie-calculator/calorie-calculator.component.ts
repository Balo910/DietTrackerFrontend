...
export class CalorieCalculatorComponent {
  ...
  calculateBMI(): void {
    ...
    if (this.bmi < 16) {
      this.interpretation = 'Wygłodzenie';
    } else if (this.bmi < 17) {
      this.interpretation = 'Wychudzenie';
    } else if (this.bmi < 18.5) {
      this.interpretation = 'Niedowaga';
    } else if (this.bmi < 25) {
      this.interpretation = 'Waga prawidłowa';
    } else if (this.bmi < 30) {
      this.interpretation = 'Nadwaga';
    } else if (this.bmi < 35) {
      this.interpretation = 'Otyłość I stopnia';
    } else if (this.bmi < 40) {
      this.interpretation = 'Otyłość II stopnia';
    } else {
      this.interpretation = 'Otyłość III stopnia';
    }
  }
